...
const InfoHub = () => {
  ...
  return (
    <div className="w-full bg-[#ffffff] text-[#202020]">
      ...
      <div className="mb-8">
        <div className="mb-4">
          <h3 className="flex items-center gap-2 text-[#6f42c1] mb-2">
      ...
      <div>
        <h3 className="text-[#6f42c1] mb-2">Connect With Us</h3>
          ...
          {socials.map((social, index) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-2 hover:text-[#6610f2] transition-colors"
              >
